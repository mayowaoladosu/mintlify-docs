...
description: "Call hosted language and embedding models through project-scoped LayerRail inference endpoints with per-project API keys and usage limits."
---
...
<CardGroup cols={2}>
  ...
  <Card title="AI Apps" icon="robot" href="/ai-inference/ai-apps" />
