...
- **Cleaner [AI inference](/ai-inference/overview) surface.** The catalog and [playground](/ai-inference/playground) have been refreshed for easier model discovery and testing.
...
- **Longer Kubernetes provisioning windows.** [Cluster](/managed-kubernetes/overview) node provisioning deadlines have been extended to accommodate slower production boots.
