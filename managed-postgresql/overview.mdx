---
title: "Managed PostgreSQL overview"
description: "Create and operate LayerRail-managed PostgreSQL databases with automated backups, version upgrades, monitoring, and vertical resizing."
---
...
<Steps>
  ...
  <Step title="Choose Create PostgreSQL Database">
    Select the create card to open the database form.
  </Step>
